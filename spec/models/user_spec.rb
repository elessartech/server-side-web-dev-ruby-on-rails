...
RSpec.describe User, type: :model do
  ...
  describe 'favorite beer' do
    ...
    it 'is the one with highest rating if several rated' do
      ...
      FactoryBot.create(:rating, score: 20, beer: beer1, user:)
      FactoryBot.create(:rating, score: 25, beer: beer2, user:)
      FactoryBot.create(:rating, score: 9, beer: beer3, user:)
  ...
  describe 'favorite style' do
    ...
    it 'is the one with highest rating if several rated' do
      ...
      beer2 = FactoryBot.create(:beer)
      beer3 = FactoryBot.create(:beer)
      rating1 = FactoryBot.create(:rating, score: 20, beer: beer1, user:)
      rating2 = FactoryBot.create(:rating, score: 25, beer: beer2, user:)
      rating3 = FactoryBot.create(:rating, score: 9, beer: beer3, user:)
